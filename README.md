...
## An example of synthetic data where the response network was generated by an additive model of the 30 random networks (predictors) with signal-to-noise equal to 1 and the first 15 predictors were related with the response. 
